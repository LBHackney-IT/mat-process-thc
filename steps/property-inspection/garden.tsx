    ...
    componentWrappers: [
      ...
      ComponentWrapper.wrapDynamic(
        new DynamicComponent({
          ...
          renderWhen(stepValues: {
            "has-garden"?: ComponentValue<DatabaseSchema, "property">;
          }): boolean {
      ...
      ComponentWrapper.wrapDynamic(
        new DynamicComponent({
          ...
          renderWhen(stepValues: {
            "garden-type"?: ComponentValue<DatabaseSchema, "property">;
          }): boolean {
      ...
      ComponentWrapper.wrapDynamic(
        new DynamicComponent({
          ...
          renderWhen(stepValues: {
            "is-maintained"?: ComponentValue<DatabaseSchema, "property">;
          }): boolean {
