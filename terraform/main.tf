...
module "staging" {
  ...
  task_definition_secrets = {
    ...
    MAT_API_DATA_SALT       = "${local.parameter_store}/staging-thc-MAT_API_DATA_SALT"
    MAT_API_DATA_ITERATIONS = "${local.parameter_store}/staging-thc-MAT_API_DATA_ITERATIONS"
    MAT_API_DATA_KEY_SIZE   = "${local.parameter_store}/staging-thc-MAT_API_DATA_KEY_SIZE"
    MAT_API_DATA_ALGORITHM  = "${local.parameter_store}/staging-thc-MAT_API_DATA_ALGORITHM"
    MAT_API_DATA_IV         = "${local.parameter_store}/staging-thc-MAT_API_DATA_IV"
  }
